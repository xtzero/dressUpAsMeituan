...
class order extends entry{
	...
	public function createOrder(){
		...
		switch($res){
			case -1: ajax(-1,'创建订单时出现错误，请稍后重试');break;
			case 1: ajax(1,'订单中有已下架商品，请重新添加');break;
			case 2: ajax(2,'余额不足，请联系店家充值');break;
			default: ajax(0,'创建订单成功',[
				'orderId' => $res
			]);
		}
	}
	...
	public function getOrderInfo(){
		...
		switch($res){
			case 1: ajax(1,'该订单不存在');break;
			default: ajax(0,'成功',$res);
		}
	}
	  ...
	  */
	  public function applyCloseOrder(){
		  ...
		  switch($res){
			  ...
			  case -1: ajax(1,'该订单不存在');break;
			  case 0: ajax(-1,'申请关闭订单时出现错误');break;
		  }
	  }
